...
def _verify_puzzletron_v2_environment(session):
    ...
    expected_versions = {
        ...
        "aiohttp": PUZZLETRON_V2_CI_ENVIRONMENT["aiohttp"],
        "antlr4-python3-runtime": PUZZLETRON_V2_CI_ENVIRONMENT["antlr4-python3-runtime"],
...
actual = {{
    ...
    "aiohttp": Version(version("aiohttp")).base_version,
    "antlr4-python3-runtime": Version(version("antlr4-python3-runtime")).base_version,
