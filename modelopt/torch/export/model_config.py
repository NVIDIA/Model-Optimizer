...
# Block-wise FP8, weight-only (BF16 activations at serve time) -> compressed-tensors W8A16.
QUANTIZATION_FP8_PB_WO = "fp8_pb_wo"
# Block-wise FP8 weights + dynamic per-token FP8 activations (W8A8) -> flat quant_method: fp8.
