...
try:
    ...
    # passing txt_seq_lens is deprecated. Keep the plugin compatible with the
    # broader diffusers versions supported by ModelOpt.
        ...
        def _hook(_module: nn.Module, _inputs: Any, output: Any) -> None:
            ...
            if s != expected_s:
                raise RuntimeError(
                    ...
                    "drift from the current batch setting?"
                )
