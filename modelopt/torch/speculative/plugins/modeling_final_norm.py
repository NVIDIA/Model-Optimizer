...
_FINAL_NORM_TYPE_BY_MODEL_TYPE: dict[str, str] = {
    ...
    # Nemotron-H hybrid Mamba/attention/MoE (e.g. NVIDIA-Nemotron-3.5-Lightning-30B-A3B).
    # Its final norm (NemotronHModel.norm_f) is a plain RMSNorm despite the hybrid stack.
    "nemotron_h": "rmsnorm",
