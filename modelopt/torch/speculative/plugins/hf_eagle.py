...
from ..eagle.utils import expand_mask, make_causal_mask, masked_soft_target_cross_entropy
from ..utils import (
...
class HFEagleModel(EagleModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        for ttt_step in range(num_ttt_steps):
            ...
            cache_to_pass = None if self.eagle_mix_hidden_states else eagle_cache
    ...
    def _eagle_loss(
        ...
        classification_loss = masked_soft_target_cross_entropy(
            base_output_softmax_logits,
            eagle_logits,
            loss_mask,
        )
        ...
        valid = loss_mask[:, : eagle_logits.shape[1]].bool()
