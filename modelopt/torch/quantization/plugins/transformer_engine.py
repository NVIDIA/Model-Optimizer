...
class _QuantTEGroupedLinear(_ParallelLinear):
    ...
    def modelopt_post_restore(self, prefix: str = ""):
        ...
        try:
            ...
            self.weight_quantizer = grouped_weight_quantizer
    ...
    def _get_weight_quantizer(self, gemm_idx: int):
        return self.weight_quantizer[gemm_idx]

    def _gather_per_expert_amax(self) -> torch.Tensor:
        """Stack N per-expert weight quantizer amax scalars into a [N] fp32 vector.
