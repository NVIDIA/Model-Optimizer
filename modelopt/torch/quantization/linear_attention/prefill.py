...
from .reference import _prepare, state_qdq_reference
...
def _matmul_prefill(
    ...
    *,
    ...
    if state_qdq:
        state = state_qdq_reference(state, policy.state.block_v, state_format)
    outputs = []
    for c in range(count):
        ...
        if state_qdq:
            next_state = state_qdq_reference(next_state, policy.state.block_v, state_format)
