...
def max_calibrate(
    ...
    bootstrap_weight_quantizers=True,
):
    ...
    Args:
        ...
        bootstrap_weight_quantizers: Whether to fill missing weight amax values from weights.
    ...
    if bootstrap_weight_quantizers:
...
def awq_lite(
    ...
    **kwargs,
    ...
    max_calibrate(model, lambda model: None, bootstrap_weight_quantizers=False)
