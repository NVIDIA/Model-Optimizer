    ...
    with import_plugin(
        ...
        with import_plugin("transformers"):
            from .hf_triton_attention import (
                register_triton_attention as _register_triton_attention,
                set_skip_threshold as _set_skip_threshold,
            )

            register_triton_attention = _register_triton_attention
            set_skip_threshold = _set_skip_threshold
