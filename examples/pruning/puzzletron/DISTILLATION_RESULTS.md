...
Distillation results for models compressed with [Puzzletron](./README.md) MIP-based heterogeneous pruning, followed by Megatron-Bridge knowledge distillation.
...
- [Puzzletron pruning example](./README.md)
