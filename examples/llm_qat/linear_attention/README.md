...
[Neumann policy](#approximate-triangular-solve-for-linear-attention-qat) enables polynomial approximation.
...
[study result](solve_study.md). Keep exact solve for that model.
...
Use the [pinned model study](#prefill-model-study) for
...
[qualification result](solve_study.md); these
