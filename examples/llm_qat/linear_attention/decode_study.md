...
These measurements describe the recorded implementation and workloads below;
they do not qualify later revisions or INT8/Hadamard policies.
...
[decode_study_plan.json](decode_study_plan.json) fixes selection before held-out test access. Every
