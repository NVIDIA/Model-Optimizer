...
# discovered and exposed as a valid CLI value via _PresetCfgChoices, so no code
# change is required when a YAML is added or removed. This is deliberate: every
