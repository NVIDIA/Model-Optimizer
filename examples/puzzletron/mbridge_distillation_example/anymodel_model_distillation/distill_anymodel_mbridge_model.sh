...
#
# Knowledge Distillation Training Script for Megatron-Bridge (AnyModel)
#
...
#  bash distill_anymodel_mbridge_model.sh model.tensor_model_parallel_size=8 model.teacher.tensor_model_parallel_size=8 train.global_batch_size=4 train.micro_batch_size=1 dataset.sequence_length=8192 train.train_iters=5000 logger.log_interval=1
#

# Default paths
STUDENT_CKPT="/workspace/mbridge_models/anymodel_teacher/iter_0000000"
TEACHER_CKPT="/workspace/mbridge_models/anymodel_teacher/iter_0000000"
...
# Use distill.py from hf_model_distillation (same script works for both)
DISTILL_SCRIPT="${SCRIPT_DIR}/../hf_model_distillation/distill.py"
...
echo "Starting knowledge distillation (AnyModel)..."
