...
#  bash distill_decilm_mbridge_model.sh model.tensor_model_parallel_size=8 model.teacher.tensor_model_parallel_size=8 train.global_batch_size=4 train.micro_batch_size=1 dataset.sequence_length=8192 train.train_iters=5000 logger.log_interval=1
#

# Default paths
STUDENT_CKPT="/workspace/mbridge_models/decilm_teacher/iter_0000000"
TEACHER_CKPT="/workspace/mbridge_models/decilm_teacher/iter_0000000"
