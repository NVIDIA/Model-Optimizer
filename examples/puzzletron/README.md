...
## Understand sorting, width ranking, and slicing
...
### What does width sanity measure?
...
and reverse controls within the configured comparison tolerance. Loss-like
metrics are lower-is-better; accuracy-like metrics are higher-is-better. A
ranking miss occurs when the activation-sorted value is worse than a control by
...
### What is an equivalence failure?
...
### How stage completion and qualification differ
...
acceptance. See
[`docs/v2_architecture.md`](docs/v2_architecture.md#semantic-validation-gates)
