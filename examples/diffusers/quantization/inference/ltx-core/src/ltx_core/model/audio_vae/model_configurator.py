...
from ltx_core.model.audio_vae.audio_vae import Decoder
...
VOCODER_COMFY_KEYS_FILTER = SDKeyOps(
    ...
    mapping=(
        CompulsoryContent(prefix="vocoder."),
        ContentReplacement("vocoder.", ""),
    ),
)
...
AUDIO_VAE_DECODER_COMFY_KEYS_FILTER = SDKeyOps(
    name="AUDIO_VAE_DECODER_COMFY_KEYS_FILTER",
    mapping=(
        CompulsoryContent(prefix="audio_vae.decoder."),
        CompulsoryContent(prefix="audio_vae.per_channel_statistics."),
        ContentReplacement(content="audio_vae.decoder.", replacement=""),
        ContentReplacement(content="audio_vae.per_channel_statistics.", replacement="per_channel_statistics."),
    ),
)
