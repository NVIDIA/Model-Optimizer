...
"""Entrypoint for Qwen-Image PDD training with released AutoModel components."""
...
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(_FASTGEN_DIR)))
...
Qwen-Image PDD training with released NeMo AutoModel components.
...
def main(
    default_config_path: str = "examples/diffusers/fastgen/pdd/configs/qwen_image.yaml",
) -> None:
    ...
    from pdd.recipe import PDDDiffusionRecipe
