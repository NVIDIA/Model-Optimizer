...
- Add bounded directory-backed NPY/NPZ calibration readers to the ONNX PTQ API and CLI, together with an end-to-end PETRv1 and PETRv2 example covering nuScenes calibration and accuracy evaluation, INT8 and FP8 backbone/head quantization, and TensorRT engine benchmarking.
