...
- Add reproducible Qwen 3.5 VLM pruning campaigns with pinned dataset preparation, multi-axis search and materialization, matched teacher/student evaluation, short knowledge distillation, and compatible-stage resume.
