...
- Add checkpoint recipes for the NVIDIA-source releases: NVIDIA-Nemotron-3-Nano-30B-A3B (FP8 and NVFP4), NVIDIA-Nemotron-3-Super-120B-A12B FP8, and Nemotron-3-Nano-Omni-30B-A3B-Reasoning (FP8 and NVFP4). Recipes for the remaining source-model orgs follow in separate changes.
