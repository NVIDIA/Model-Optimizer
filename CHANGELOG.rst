...
- Fix FP8 MHA quantization for diffusion attention modules that delegate to a module-level helper, and preserve fusion-ready Q/DQ placement around attention scaling, key transposes, and softmax outputs in exported ONNX graphs.
