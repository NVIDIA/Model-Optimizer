...
- Add experimental GDN/KDA decode-aware QAT with FP8 or signed symmetric dynamic INT8 recurrent states, KDA decay rounding, and encoded-update replay. Supply explicit prefix lengths through the training phase context; prefix solves remain exact.
