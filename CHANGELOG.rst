...
- Add ``examples/minimax_m3/hf_ptq_mixed_mxfp8_nvfp4.py`` and its model-specific recipe to export MiniMax-M3 with the vendor MXFP8 base and routed experts quantized directly from BF16 to NVFP4, one MoE layer at a time.
