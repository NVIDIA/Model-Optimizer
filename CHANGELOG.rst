...
- Add IQ1_S and IQ2_XS weight quantization and unified Hugging Face checkpoint export. Supported weights are encoded in GGML-compatible 256-value blocks and stored as packed ``uint8`` payloads with their logical shapes in safetensors.
