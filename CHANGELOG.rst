...
- Add Puzzletron - a new algorithm for heterogeneous pruning of LLM and VLM models. See `examples/pruning/puzzletron/README.md <https://github.com/NVIDIA/Model-Optimizer/tree/main/examples/pruning/puzzletron>`_ for more details.
