...
The ``modelopt.onnx.quantization.autotune`` module optimizes Q/DQ (Quantize/Dequantize) placement in ONNX models. It explores placement strategies and uses TensorRT latency measurements to choose a configuration that minimizes inference time.
