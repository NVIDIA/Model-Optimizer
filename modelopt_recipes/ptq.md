...
- **`models/nvidia/MiniMax-M2.7-NVFP4/ptq/nvfp4_experts_only-kv_fp8_cast`** uses
  max-calibrated NVFP4 W4A4 experts (block size 16) and FP8 KV-cache cast mode;
  attention projections, router, and LM head stay BF16.
