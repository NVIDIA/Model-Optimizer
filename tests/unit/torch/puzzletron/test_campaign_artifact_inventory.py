...
def test_dedicated_stage_manifest_symlink_boundary_is_incompatible(tmp_path, symlink_kind):
    ...
    assert (
        "source_stage_manifest_symlink" in inventory["artifacts"]["activation"]["incompatibilities"]
    )
...
def test_tampered_source_stage_semantic_identity_is_incompatible(tmp_path):
    ...
    assert (
        "source_semantic_config_identity"
        in inventory["artifacts"]["activation"]["incompatibilities"]
    )
