...
QWEN_DENSE_MODEL_CONFIG = "examples/puzzletron/configs/families/qwen3_5/qwen3p5_9b/model.yaml"
...
def test_qwen_dense_model_metadata_matches_public_checkpoint() -> None:
    path = REPOSITORY_ROOT / QWEN_DENSE_MODEL_CONFIG
