...
class TestValidateOnline:
    ...
    def test_all_accepted(self):
        ...
        # The histogram is what the published profile is built from, so a collection
        # defect must fail here rather than only showing up in the scalar.
        assert validator.last_length_histogram == {3: 1}
